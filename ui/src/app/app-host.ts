...
import { createHandoffAppElement } from "../components/browser/handoff-app-element.ts";
import type {
...
if (!customElements.get("openclaw-app")) {
  ...
  customElements.define("openclaw-app", access ? createHandoffAppElement(access) : OpenClawApp);
}
