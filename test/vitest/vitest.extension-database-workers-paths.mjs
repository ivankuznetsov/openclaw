...
export const databaseWorkerExtensionTestFiles = [
  ...
  "extensions/browser/src/browser/session-tab-registry.handoff.test.ts",
  ...
  "extensions/browser/src/human-intervention/http.chromium.test.ts",
  "extensions/browser/src/human-intervention/http.screencast.chromium.test.ts",
