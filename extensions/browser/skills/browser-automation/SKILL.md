...
5. Report real blockers:
   ...
   - If handoff is unavailable for the current profile or the blocked step requires a native OS dialog that the viewer cannot operate, explain the specific blocker and supported manual action. Do not invent a link or switch to an unrelated tab/profile.
